...
<body background='background.png'>
   ...
   <div class="container mt-5">
        <form method="POST">
            ...
            <input type="text" placeholder="name" class="form-control my-3 bg-dark text-white text-center" name="name">
            <input type="text" placeholder="Blog Title" class="form-control my-3 bg-dark text-white text-center" name="title">
            <input type="text" placeholder="Blog Rating" class="form-control my-3 bg-dark text-white text-center" name="rating">
